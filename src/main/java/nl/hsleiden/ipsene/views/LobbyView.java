...
public class LobbyView implements View{
    ...
    // De IsAvailable bool is om aan te geven of de player slot beschikbaar is of niet, ofwel, kan je nog die slot
    // joinen of niet.
    ...
    //
    // De hex waardes die je nodig hebt voor de player colors staan al in de final variables van deze functie! lekker handig!
    ...
    private Label playerDisplayLabel(String txt, boolean isAvailable, String hex){
        ...
        lbl.setStyle("-fx-font-size: 35; -fx-padding: 20; -fx-border-width: 10; " +
                "-fx-background-color: #AAAAAA; -fx-border-color: " + avIndicator + avIndicator + avIndicator + hex);
